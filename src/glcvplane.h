...
class GLCVPlane
{
	public:
		...
		void 	PlaneCreateTex			(int texture_w, int texture_h, int ch);
		void  PlaneDestroyTex		(void);
		...
		void 	PlaneSetTex				(IplImage *texture_data);
		void 	PlaneSetTexBin				(IplImage *texture_data);
		void 	PlaneSetTexBuf				(char *texture_data, int w, int h);
		void  PlaneSetColor 			(CvScalar color);
		...
		void	PlaneLoadGLTextures 	(EGLDisplay egldisplay, IplImage *texture);
